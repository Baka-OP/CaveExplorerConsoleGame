...
namespace Space_cave_expedition.LegacyModels
{
    class LegacyMap
    {
        ...
        public LegacyMap(string mapTemplate, ConsoleColor backgroundColor, ConsoleColor wallColor, ControllableEntity focusedEntity)
        {
        ...
        private void DisplayMap()
        {
            ...
            sw.Stop();
            Console.WriteLine(sw.ElapsedMilliseconds.ToString().PadRight(5));
        }
